...
RUN apt-get update && \
     ...
     ros-noetic-depthimage-to-laserscan ros-noetic-map-server python3-tf-conversions ros-noetic-global-planner ros-noetic-rqt ros-noetic-rqt-graph ros-noetic-rqt-tf-tree && \
